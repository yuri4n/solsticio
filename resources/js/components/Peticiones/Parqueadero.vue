    ...
    <div class="row my-5">
      <div class="col-md-8">
        <div class="card text-left">
          <div class="card-body">
            <h3 class="card-title">Formulario de peticion de parqueadero</h3>
            <p
              class="card-text"
            ...
            <hr>
            <form action="POST" v-on:submit.prevent="sendPetition()">
              <div class="form-row">
                <div class="form-group col-md-4">
                  <label for="deudas">¿Tiene deudas con la administración?</label>
                  <v-select
                    v-model="deudas"
                ...
                <div class="form-group col-md-4 text-center">
                  <label for="vehiculo">¿Qué tipo de vehículos tiene?</label>
                  <p-check class="p-default p-thick" v-model="carro">Carro</p-check>
                  <p-check class="p-default p-thick" v-model="moto">Moto</p-check>
                </div>
                <div class="form-group col-md-4">
                  <label for="discapacidad">¿Su vehículo posee placas de discapacidad?</label>
                  <v-select
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="asignado">¿Posee actualmente parqueadero asignado?</label>
                  <v-select
                    v-model="asignado"
                    :options="[{label: 'No', value: 'NO'}, {label: 'Si', value: 'SI'}]"
                  ></v-select>
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <v-select
                    v-model="tipo"
                    :options="[{label: 'Propietario', value: 'PROPIETARIO'}, {label: 'Arrendatario', value: 'ARRENDATARIO'}]"
                  ></v-select>
                </div>
              </div>
              <hr>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-7">
                  <label for="email_propietario">E-mail</label>
                  <input
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="nombre_residente">Nombre completo del solicitante</label>
                  <input
                ...
                <div class="form-group col-md-6">
                  <label for="telefono_residente">Teléfono</label>
                  <input
                ...
                <div class="form-group col-md-5">
                  <label for="direccion_residente">Dirección</label>
                  <input
              ...
              <div class="form-group">
                <label for="cedula">Fotocopia de la Cédula</label>
                <input type="file" class="form-control-file" id="cedula" @change="cedulaNew">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="file" class="form-control-file" id="soat" @change="soatNew">
              </div>
              <div class="form-group">
                <label for="autorizacion">Autorizacion del propietario</label>
                <input
                  type="file"
                  class="form-control-file"
                  id="autorizacion"
              ...
              <h5>Asegúrese de tomarlos de la targeta de propiedad*</h5>
              <div class="form-row">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="diligenciador">Nombre completo del diligenciador</label>
                  <input
      ...
      <div class="col-md-4">
        <div class="card text-left">
          <div class="card-body">
            ...
            <p
              class="card-text"
            >Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iusto, in numquam quibusdam.</p>
          </div>
        </div>
      </div>
    </div>
