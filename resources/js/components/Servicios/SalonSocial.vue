        ...
        <div class="row my-5">
            <div class="col-xl-7">
                <div class="card">
                    ...
                    <img alt="imagen_salon_social" class="card-img-top" src="../../../images/social.jpg">
                    <div class="card-body">
                    ...
                    <div class="card-body" v-if="this.$auth.isAuthenticated() && user.status === 'APPROVED'">
                        ...
                        <form action="POST" v-on:submit.prevent="sendReservation()">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="texto" rows="6" v-model="newAditional"></textarea>
                            </div>
                            <button class="btn btn-primary mb-2" type="submit" v-on:click="newType='SS'">Enviar</button>
                        </form>
                    </div>
