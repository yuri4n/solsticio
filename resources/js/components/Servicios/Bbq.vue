<template>
    <div class="container">
        ...
        <div class="row my-5">
            <div class="col-xl-7">
                <div class="card">
                    <div class="card-header"><h2>BBQ</h2></div>
                    <img alt="imagen_bbq" class="card-img-top" src="../../../images/bbq.jpg">
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body" v-if="this.$auth.isAuthenticated() && user.status === 'APPROVED'">
                        ...
                        <form action="POST" v-on:submit.prevent="sendReservation()">
                            ...
                            <button class="btn btn-primary mb-2" type="submit" v-on:click="newType='BBQ'">Enviar
                            </button>
                        </form>
                    </div>
