    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="card mb-4" v-bind:key="post.id" v-for="post in posts">
                    <img
                        :src="post.file"
                        alt="Card image cap"
                        class="card-img-top"
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <li class="page-item" v-bind:class="[{disabled: !pagination.prev_page_url}]">
                            <a @click="readPosts(pagination.prev_page_url)" class="page-link" href="#">Anterior</a>
                        </li>
                        ...
                        <li class="page-item" v-bind:class="[{disabled: !pagination.next_page_url}]">
                            <a @click="readPosts(pagination.next_page_url)" class="page-link" href="#">Siguiente</a>
                        </li>
                    </ul>
                </nav>
            </div>
